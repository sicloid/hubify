...
import { updateInsurerProfile } from "./actions";

export default async function InsurerProfilePage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 className="flex items-center gap-2 text-2xl font-bold">
              ...
              Sigorta Profil Ayarı
            </h1>
            <p className="mt-2 text-sm text-slate-300">Sigorta profili ve şifre bilgilerini bu ekrandan güncelle.</p>
          </div>
          <Link
            href="/sigorta"
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action={updateInsurerProfile} className="space-y-5">
