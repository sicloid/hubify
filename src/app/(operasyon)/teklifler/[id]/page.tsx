    ...
    <div className="p-8 max-w-5xl mx-auto space-y-8">
      <div>
        ...
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Mikro-İhracat Talebi: {talep.id}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {talep.isConsolidationEligible && (
            <div className="bg-brand-secondary/10 border border-brand-secondary/20 rounded-xl p-5 flex gap-4 items-start">
              <Info className="w-6 h-6 text-brand-secondary flex-shrink-0 mt-0.5" />
              <div>
                <h4 className="text-base font-medium text-slate-900">Konsolidasyon Fırsatı</h4>
                <p className="text-sm text-slate-700 mt-1">
                  İhracatçı bu yükün diğer parsiyel yüklerle birleştirilmesine izin vermiştir. Kendi konsolidasyon havuzunuzdaki diğer yüklerle birleştirerek rekabetçi bir fiyat teklifi sunabilirsiniz.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-2 gap-y-6 gap-x-4">
              <div>
                <dt className="text-sm font-medium text-slate-500">İhracatçı KOBİ</dt>
                <dd className="mt-1 text-sm text-slate-900 font-medium">{talep.ihracatci}</dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-slate-500">Ürün Kategorisi</dt>
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-slate-900 font-semibold text-brand-secondary">{talep.agirlik} / {talep.hacim}</dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-slate-500">Yükleme Tipi</dt>
                <dd className="mt-1 text-sm text-slate-900 font-medium">{talep.konteyner}</dd>
              </div>
              <div className="col-span-2">
                ...
                <dd className="mt-1 text-sm text-slate-900 flex items-center gap-2">
                  <span className="font-medium text-slate-900">{talep.kalkis}</span>
                  <span className="text-slate-400">→</span>
                  <span className="font-medium text-slate-900">{talep.varis}</span>
                </dd>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden sticky top-8">
            ...
            <form className="p-6 space-y-4">
              <div className="space-y-2">
                <label className="block text-sm font-medium text-slate-700">Konsolide Edilmiş Tutar (USD)</label>
